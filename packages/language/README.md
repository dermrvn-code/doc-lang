...
- [src/doc-lang.langium](src/doc-lang.langium) -  The grammar definition of your language
- [src/doc-lang-module.ts](src/doc-lang-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/doc-lang-validator.ts](src/doc-lang-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/doc-lang.monarch.ts](src/syntaxes/doc-lang.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/doc-lang.tmLanguage.json](syntaxes/doc-lang.tmLanguage.json) - Textmate based syntax highlighting instructions.
